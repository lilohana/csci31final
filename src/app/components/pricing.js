    ...
    <div className="bg-gradient-to-r from-black to-gray-900">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl sm:text-center">
          <h2 className="text-3xl font-bold tracking-tight text-gray-200 sm:text-5xl">Membership Options</h2>
        </div>
            ...
            <div key={card} className="rounded-3xl ring-1 ring-gray-200 mb-32 flex flex-col w-full justify-between">
              <div className="p-8 sm:p-10 lg:flex-auto">
                ...
                <div className="mt-10 flex items-center gap-x-4">
                  <h4 className="flex-none text-lg font-semibold leading-6 text-red-600">What’s included</h4>
              ...
              <div className="mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
                <div className="bg-gray-200 rounded-2xl py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
                  <div className="mx-auto max-w-xs px-8">
                    ...
                    <a
                      href="#"
                      className="mt-10 block w-full rounded-md bg-red-600 px-3 py-2 text-center text-lg font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                    >
                      Join Now
                    </a>
                  </div>
